...
Built slice-by-slice against the [requirements](../attributes-screen-requirements.md), [user stories](../user-stories.md), [system map](../system-map.md), and [flow diagrams](../flow-diagrams.md). The earlier static HTML mockup lives at [../mockups.html](../mockups.html). Outstanding work is tracked in [../prototype-todo.md](../prototype-todo.md).
