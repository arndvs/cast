...
- **Decision IDs.** Architectural choices were originally numbered D1–D32 in the design docs. Inline references have been expanded to descriptive labels; the canonical register remains in [flow-diagrams.md](flow-diagrams.md).
